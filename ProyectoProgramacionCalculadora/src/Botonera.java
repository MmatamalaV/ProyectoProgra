...
public class Botonera {
    ...
    HBox basico(){
       ...
       simbolos2.getChildren().addAll(buttonPar2, buttonMenos,buttonDiv);
        ...
        trigonometria.getChildren().removeAll(buttonSen, buttonCos, buttonTan);
       ...
       //-------------------------------------//
        ...
        button7.setOnAction((ActionEvent event) ->
         ...
         {
             double n =0;
             NumerosYSimbolos num7 = new NumerosYSimbolos(n, pantalla.getEspacioNumero(),pantalla.getEspacioSuperior(), pantalla.isPuntosVisibles());
             pantalla.agregarACentro(num7.numero7());
             pantalla.contador(false);
    ...
    HBox cientifica(){
        HBox contenerdorPrincipal = new HBox();
        Button button7 = new Button(" 7 ");
        contenerdorPrincipal.getChildren().add(button7);
        return contenerdorPrincipal;
    }
}
